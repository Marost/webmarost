                ...
                <ul>
                    <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="images-slider/thumbs/thumb1.jpg">
                        ...
                        <div class="tp-caption sfl"
                            ...
                            data-start="1200"
                            data-easing="easeOutExpo">
                            <i class="icon-check"></i>Multi Core Processor Intel Xeon
                        </div>
                        ...
                        <div class="tp-caption sfl"
                            ...
                            data-start="1400"
                            data-easing="easeOutExpo">
                            <i class="icon-check"></i>10TB Hardisk Space & Unlimited Domain
                        </div>
                        ...
                        <div class="tp-caption sfl"
                            ...
                            data-start="1600"
                            data-easing="easeOutExpo">
                            <i class="icon-check"></i>24/7 Support Staff Available
                        </div>
                    ...
                    <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="images-slider/thumbs/thumb1.jpg">
                        ...
                        <div class="tp-caption sfl"
                            ...
                            data-start="1200"
                            data-easing="easeOutExpo">
                            <i class="icon-check"></i>Professional and Dedicated Support
                        </div>
                        ...
                        <div class="tp-caption sfl"
                            ...
                            data-start="1400"
                            data-easing="easeOutExpo">
                            <i class="icon-check"></i>You Can Contact Us by Phone or Email
                        </div>
        ...
        <div id="content" class="no-bottom">
            <div class="container">
                ...
                <div class="block-title text-center">
                    <h1>Paquete disponibles</h1>
                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium
                </div>
                <div class="pricing-3-col pricing-dark">
                    <!-- pricing box begin -->
                    <div class="pricing-box">
                        <ul>
                            ...
                            <li class="deco"><strong>10GB</strong> de espacio</li>
                            <li><strong>10GB</strong> de banda ancha</li>
                            <li class="deco"><strong>CPanel</strong></li>
                            <li><strong>Emails</strong> ilimitados</li>
                ...
                <div class="row">
                    <div class="feature-box-image span4">
                        <div class="inner">
                            <div class="text">
                                <img src="imagenes/blank.png" data-original="imagenes/feature-pic-1.jpg" alt="">
                                <h3>High Performance</h3>
                                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.
                            </div>
                        </div>
                    ...
                    <div class="feature-box-image span4">
                        <div class="inner">
                            <div class="text">
                                <img src="imagenes/blank.png" data-original="imagenes/feature-pic-2.jpg" alt="">
                    ...
                    <div class="feature-box-image span4">
                        <div class="inner">
                            <div class="text">
                                <img src="imagenes/blank.png" data-original="imagenes/feature-pic-3.jpg" alt="">
                                <h3>Reliable Hardware</h3>
                                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.
                            </div>
                        </div>
                ...
                <div class="flexslider logo-carousel no-control">
                    <ul class="slides">
                        ...
                        <li>
                            <div class="span2">
                                <img src="imagenes/logo/2.png" alt="">
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="imagenes/logo/3.png" alt="">
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="imagenes/logo/4.png" alt="">
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="imagenes/logo/5.png" alt="">
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="imagenes/logo/6.png" alt="">
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="imagenes/logo/7.png" alt="">
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="imagenes/logo/8.png" alt="">
                            </div>
                        </li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="flexslider testi-slider">
                            <ul class="slides">
                                <li>
                                    <blockquote>"Si tus acciones inspiran a otros a soñar más, aprendes más, hacer más y a ser mejores; eres un lider."<span>Jack Welch</span></blockquote>
                                </li>
                                <li>
                                    <blockquote>"Nadie está a salvo de las derrotas. Pero es mejor perder algunos combates en la lucha por nuestros sueños, que ser derrotado sin saber siquiera por qué se está luchando."<span>Paulo Coelho</span></blockquote>
                                </li>
                            </ul>
                        </div>
                    </div>
