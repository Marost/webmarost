...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_columnista WHERE id>0 ORDER BY nombre_completo ASC;", $conexion);
...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_columnista WHERE id>0 ORDER BY nombre_completo ASC LIMIT $inicio, $registros;", $conexion);
                      ...
                      <table width="100%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        <thead>
                          <tr class="titulo-campo">
                            <th width="85%" height="22" align="left">columnistas</th>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="15%" align="center">
                                    ...
                                    <img src="../../images/editar_16.png" width="16" height="16" /></a>
                           	    	<a href="noticias/listar.php?columnista=<?php echo $fila["id"] ?>"><img src="../../images/noticia_portada.png" width="16" height="16" title="Noticias de portada" /></a>
                                </td>
                          </tr>
                          <?php } ?>
                        </tbody>
