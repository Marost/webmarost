...
//LISTA COMENTARIOS
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_saludos WHERE estado_saludo='I' ORDER BY fecha DESC;", $conexion);
...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_saludos WHERE estado_saludo='I' ORDER BY fecha DESC LIMIT $inicio, $registros;", $conexion);
...
if(confirm("Se borrara el saludo de: "+titulo+"\n¿Está seguro?")) {
	document.location.href="eliminar.php?id="+comentario;
	}
}

function aprobarComentario(comentario, titulo) {
if(confirm("Se publicara el saludo de: "+titulo+"\n¿Está seguro?")) {
	document.location.href="aprobar.php?id="+comentario;
	}
}
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Saludos sin Aprobar --- <a href="listar-aprobados.php">Saludos Aprobados</a></h2>
      ...
      <td colspan="2" align="center">
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
          ...
          <tr<?php echo alt($zebra); $zebra++; ?>>
            <td width="80%"><p>Por: <strong><?php echo $fila_query2["nombre"]; ?></strong> el <strong><?php echo $fila_query2["fecha"]; ?></strong></p></td>
            <td width="20%" align="center" valign="middle"><p><strong>Acciones:</strong>
              
              	<a onclick="eliminarComentario(<?php echo $fila_query2["id"].", '".$fila_query2["nombre"]."'"; ?>)" href="javascript:;">
               		<img src="../../../images/eliminar_16.png" width="16" height="16" border="0" title="Eliminar comentario" /></a>&nbsp;
                    
                <a onclick="aprobarComentario(<?php echo $fila_query2["id"].", '".$fila_query2["nombre"]."'"; ?>)" href="javascript:;">
                    <img src="../../../images/check_16.png" width="16" height="16" alt="Aprobados" /></a></p></td>
            </tr>
          <tr<?php echo alt($zebra); $zebra++; ?>>
            <td colspan="2">
