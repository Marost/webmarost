...
//LISTA COMENTARIOS
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_cartas WHERE estado='I' ORDER BY fecha_publicacion DESC;", $conexion);
...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_cartas WHERE estado='I' ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
...
if(confirm("Se borrara la carta de: "+titulo+"\n¿Está seguro?")) {
	document.location.href="eliminar.php?id="+comentario+"&tipo=sr";
	}
}

function cartaAprobada(comentario, titulo) {
if(confirm("Se publicara la carta de: "+titulo+"¿Está seguro?")){
	document.location.href="guardar_publicar.php?id="+comentario;
	}
}
</script>
</head>
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Cartas sin Aprobar --- <a href="listar.php">Cartas Aprobadas</a></h2>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
          ...
          <tr<?php echo alt($zebra); $zebra++; ?>>
            ...
            <td width="20%" align="center" valign="middle"><p><strong>Acciones:</strong>
               ...
               &nbsp;
               <a onclick="cartaAprobada(<?php echo $fila_query2["id"].", '".$fila_query2["titulo"]."'"; ?>)" href="javascript:;">
               		<img src="../../../images/check_16.png" width="16" height="16" />
               </a>
               </p></td>
            </tr>
          <tr<?php echo alt($zebra); $zebra++; ?>>
