...
//LISTA COMENTARIOS
$rst_query=mysql_query("SELECT *, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha2 FROM ".$tabla_suf."_noticia_comentario WHERE noticia=$idnoticia AND estado_comentario='A' ORDER BY id DESC;", $conexion);
...
$rst_query=mysql_query("SELECT *, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha2 FROM ".$tabla_suf."_noticia_comentario WHERE noticia=$idnoticia AND estado_comentario='A' ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2><a href="comentarios.php?id=<?php echo $fila_noticia["id"]; ?>">Comentarios sin Aprobar</a> --- Comentarios Aprobados</h2>
        ...
        <tr<?php echo alt($zebra); $zebra++; ?>>
          ...
          <td width="20%" align="center" valign="middle"><p><strong>Acciones:</strong>
            ...
            <a onclick="eliminarComentario(<?php echo $fila_query2["id"] ?>, <?php echo $idnoticia; ?>)" href="javascript:;">
                <img src="../../../images/eliminar_16.png" width="16" height="16" title="Eliminar comentario" /></a></p></td>
        </tr>
        <tr<?php echo alt($zebra); $zebra++; ?>>
          <td colspan="2">
