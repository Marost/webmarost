...
//LISTA COMENTARIOS
$rst_query=mysql_query("SELECT *, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha2 FROM ".$tabla_suf."_noticia_comentario WHERE noticia=$idnoticia AND estado_comentario='I' ORDER BY id DESC;", $conexion);
...
$rst_query=mysql_query("SELECT *, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha2 FROM ".$tabla_suf."_noticia_comentario WHERE noticia=$idnoticia AND estado_comentario='I' ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
...
function aprobarComentario(comentario, noticia) {
if(confirm("¿Está seguro de aprobar este comentario?")) {
	document.location.href="aprobar-comentario.php?id="+comentario+"&noticia="+noticia;
	}
}
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Comentarios sin Aprobar --- <a href="comentarios-aprobados.php?id=<?php echo $fila_noticia["id"]; ?>">Comentarios Aprobados</a></h2>
      ...
      <?php while($fila_query2=mysql_fetch_array($rst_query)){ ?>
        <tr<?php echo alt($zebra); $zebra++; ?>>
          ...
          <td width="20%" align="center" valign="middle"><p><strong>Acciones:</strong>
            ...
            <a onclick="aprobarComentario(<?php echo $fila_query2["id"] ?>, <?php echo $idnoticia; ?>)" href="javascript:;">
            	<img src="../../../images/check_16.png" width="16" height="16" alt="Aprobar" title="Aprobar comentario" /></a></p></td>
        </tr>
        <tr<?php echo alt($zebra); $zebra++; ?>>
          <td colspan="2">
