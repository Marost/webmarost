...
// Data Gathering
$params['sql_query']                = "SELECT id,titulo,fecha_publicacion FROM ".$tabla_suf."_portafolio ORDER BY fecha_publicacion DESC, id DESC";
...
<div id="content">
    ...
    <div class="wrapper">
        ...
        <!-- Media table sample -->
        <div class="widget">
            <div class="whead"><h6>Portafolio</h6></div>
