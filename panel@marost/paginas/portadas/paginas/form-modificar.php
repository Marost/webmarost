...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_fotografo_foto WHERE id=". $_REQUEST["id"].";", $conexion);
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Modificar - Pagina</h2>
    <div id="contenido_total">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
            	<td>
                <form action="actualizar.php?id=<?php echo $_REQUEST["id"]; ?>&portada=<?php echo $idportada; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
