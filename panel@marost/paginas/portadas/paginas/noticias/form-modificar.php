...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_portada_paginas_noticias WHERE id=". $_REQUEST["id"].";", $conexion);
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2><a href="../listar.php?portada=<?php echo $idportada ?>">Paginas</a> &lt; <a href="listar.php?portada=<?php echo $idportada ?>&amp;pagina=<?php echo $idpagina ?>">Noticias</a> &lt; Modificar Noticia</h2>
    <div id="contenido_total">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
            	<td>
                <form action="actualizar.php?id=<?php echo $_REQUEST["id"]; ?>&pagina=<?php echo $idpagina; ?>&portada=<?php echo $idportada; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
