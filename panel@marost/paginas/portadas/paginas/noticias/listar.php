...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_portada_paginas_noticias WHERE id>0 AND portada=$idportada AND pagina=$idpagina ORDER BY fecha DESC;", $conexion);
...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_portada_paginas_noticias WHERE id>0 AND portada=$idportada AND pagina=$idpagina ORDER BY fecha DESC LIMIT $inicio, $registros;", $conexion);
...
function eliminarRegistro(registro, portada, pagina) {
if(confirm("¿Está seguro de borrar este registro?\n"+nombre)) {
	document.location.href="eliminar.php?id="+registro+"&portada="+portada+"&pagina="+pagina;
	}
}
</script>
</head>
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2><a href="../listar.php?portada=<?php echo $idportada ?>">Páginas</a>&lt;Lista - Noticias</h2>
    <div id="contenido_total">
        ...
        <div id="contenido">
              ...
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2"><p><a href="form-agregar.php?pagina=<?php echo $idpagina; ?>&portada=<?php echo $idportada; ?>"><strong>AGREGAR NOTICIA</strong></a></p></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <table width="100%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        <thead>
                          <tr class="titulo-campo">
                            <th width="85%" height="22" align="left">NOTICIAS</th>
    ...
    <a onclick="eliminarRegistro(<?php echo $fila["id"].",".$idportada.",".$idpagina; ?>);" href="javascript:;">
                                    <img src="../../../../images/eliminar_16.png" width="16" height="16" title="Eliminar registro" /></a>
                            <?php //} ?>
                      <?php //if($fila_prv_user["columnistas_modificar"]==1){ ?>
                           		<a href="form-modificar.php?id=<?php echo $fila["id"] ?>&pagina=<?php echo $idpagina; ?>&portada=<?php echo $idportada; ?>">
                                	<img src="../../../../images/editar_16.png" width="16" height="16" title="Modiciar registro" /></a>
                          	<?php //} ?>
                            <?php //if($fila_prv_user["columnistas_comentarios"]==1){ ?>
