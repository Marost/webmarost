...
//LISTA COMENTARIOS
$rst_query=mysql_query("SELECT *, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha2 FROM ".$tabla_suf."_portada_comentario WHERE noticia=$idnoticia ORDER BY id DESC;", $conexion);
...
$rst_query=mysql_query("SELECT *, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha2 FROM ".$tabla_suf."_portada_comentario WHERE noticia=$idnoticia ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
...
//NOTICIA
$rst_query4=mysql_query("SELECT *, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha2 FROM ".$tabla_suf."_portada WHERE id=$idnoticia;", $conexion);
...
<div id="contenido_total">
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr>
      <td colspan="2" align="left"><p><strong>Fecha de Portada: </strong> <?php echo $fila_query4["fecha2"]; ?></p></td>
  </tr>
<tr>
