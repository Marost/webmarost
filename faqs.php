...
<div class="page_title">
	<div class="container">
        ...
        <div class="pagenation">&nbsp;<a href="index.php">Home</a> <i>/</i> <a href="#">Features</a> <i>/</i> FAQs</div>
	</div>
</div><!-- end page title --> 
...
<div class="content_left">
    ...
    <div class="accrodation">
        ...
        <!-- section 5 -->
        <span class="acc-trigger"><a href="#">Different Awesome Slideshows. Include Slider Revolution worth of $12</a></span>
        <div class="acc-container">
        <div class="content">
        ...
        <!-- section 7 -->
        <span class="acc-trigger"><a href="#">2 Different Website Versions ( 2 Fullwidth + 2 Boxed ) as well.</a></span>
        <div class="acc-container">
        <div class="content">
        There are many variations of but the majority have suffered alteration in some form, by injected humour, or randomised words which looks.
        </div>
...
<div class="right_sidebar">
	...
	<div class="sidebar_widget">
    	<div class="sidebar_title"><h3>More <i>About Us</i></h3></div>
		<ul class="arrows_list1">		
            <li><a href="#"><i class="fa fa-angle-right"></i> Our History</a></li>
            <li><a href="#"><i class="fa fa-angle-right"></i> Professional Research</a></li>
            <li><a href="#"><i class="fa fa-angle-right"></i> Our Development</a></li>
            <li><a href="#"><i class="fa fa-angle-right"></i> Partnership With Us</a></li>
            <li><a href="#"><i class="fa fa-angle-right"></i> Company Carreer</a></li>
            <li><a href="#"><i class="fa fa-angle-right"></i> New Technology</a></li>
            <li><a href="#"><i class="fa fa-angle-right"></i> Client Testimonials</a></li>
		</ul>
	</div><!-- end section -->
    ...
    <div class="sidebar_widget">
    	...
    	<div class="sidebar_title"><h3>Recent <i>Posts</i></h3></div>
        
			<ul class="recent_posts_list">
                
                <li>
                <span><a href="#"><img src="http://placehold.it/50x50" alt="" /></a></span>
                <a href="#">Publishing packag esanse web page editos web sites versions</a>
